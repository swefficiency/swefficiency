...
def process_xlsx(xlsx_path):
    ...
    for _, row in df.iterrows():
        ...
        dir_path = Path(f"/home/ubuntu/github/SWE-Perf/data/{instance_id}")
...
# next run "find /home/ubuntu/github/SWE-Perf/logs/run_evaluation/old_debugging_coverage/debugging_coverage_sympy/gold/ -name "covering_tests.txt" -exec sh -c 'cp -r "$(dirname {})" ./data/' \;"
# which will copy the directories to the data/ directory with all the PRs that passed coverage.
# python /home/ubuntu/github/SWE-Perf/scripts/annotate/xlsx_to_data_dir.py /home/ubuntu/github/SWE-Perf/scripts/annotate/annotate_images_sympy.xlsx
