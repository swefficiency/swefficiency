...
The below content is taken from SWE-gym's fork of SWE-bench. The SWE-fficiency team is working on updating this to make creating benchmark instances more easily reproducible.
...
We include a comprehensive [tutorial](https://github.com/princeton-nlp/SWE-bench/tree/main/docs/assets/collection.md) that describes the end-to-end procedure for collecting evaluation task instances from PyPI repositories.
